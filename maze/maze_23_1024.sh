#!/usr/bin/env bash
# Shared single-GPU launcher for the disjoint 23x23, 1,024-sample RL comparison.
...
MODEL_PATH="${REPO_ROOT}/maze/checkpoints/maze_23_sft_100k/ckpt-3000"
TRAIN_DATA="${REPO_ROOT}/maze/data/maze_23_1024/train.parquet"
VAL_DATA="${REPO_ROOT}/maze/data/maze_23_1024/test.parquet"
...
TRAIN_BATCH_SIZE=32
# Actor backward uses two 2,048-trajectory accumulation rounds.
ACTOR_MICRO_BATCH_SIZE=2048
STEPS_PER_EPOCH=32
TOTAL_EPOCHS=200

#!/usr/bin/env bash
# Maze 17x17 2,048-sample MaxRL Single-GPU Training Script (LR 1e-4)
...
TRAIN_DATA="${REPO_ROOT}/maze/data/maze_17_2048/train.parquet"
VAL_DATA="${REPO_ROOT}/maze/data/maze_17_2048/test.parquet"
...
PROJECT_NAME=maxrl-maze-2048
EXPERIMENT_NAME=${ADVANTAGE_ESTIMATOR}_${N_ROLLOUTS}rollouts_lr_${LR}
